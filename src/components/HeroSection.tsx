...
const HeroSection = () => {
  return (
    ...
    <section className="font-poppins pt-25 pb-75 xl:pb-30 xl:pt-30 px-4 bg-cover bg-center bg-[url(https://furniro-web-assets-19.s3.us-east-2.amazonaws.com/hero-images/bg-hero-section.svg)]">
