...
const HeroSection = () => {
  return (
    ...
    <section className="font-poppins pt-25 pb-75 xl:pb-30 xl:pt-30 px-4 bg-cover bg-center bg-[url(src/assets/images/bg-hero-section.svg)] md:">
      ...
      <div className='bg-creme rounded-xl px-5 pt-10 pb-5 mt-30 md:ml-10 md:mr-10 xl:ml-300 xl:mr-10'>
        <div className='p-3'>
            ...
            <button className='text-white font-bold text-md bg-gold px-15 py-5 mt-10'><Link to="/shop">BUY NOW</Link></button>
        </div>
      </div>
